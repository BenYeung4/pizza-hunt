...
//tieing the necessary API calls
//gets all our pizza data, transform it into JSON data which can be used, run each one through the printPizza function using the .forEach() method.
const getPizzaList = () => {
  fetch("/api/pizzas")
